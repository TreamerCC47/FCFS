...
const scrollToSection = (href: string) => {
  ...
  className="block h-auto w-[240px] max-w-none shrink-0 sm:w-[350px]"
/>
        </Link>
        ...
        >
          ...
          <div className="mt-2 grid gap-3 border-t border-border pt-4">
            <Button
              asChild
              variant="outline"
              className="h-10 w-full gap-2 border-[#25D366] text-[#188a43] hover:bg-[#25D366]/10 hover:text-[#188a43]"
            >
              <a
                href="https://wa.me/27816733268"
                target="_blank"
                rel="noreferrer"
              >
                <MessageSquare className="h-3 w-2" />
                Chat on WhatsApp
              </a>
            </Button>
